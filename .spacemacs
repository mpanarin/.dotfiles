...
you should place your code here."
  ...
  ;; add a bind to start phoenix server
  (defconst phoenix-server-start (lambda () (interactive) (alchemist-mix-execute "phoenix.server")))
  (spacemacs/set-leader-keys-for-major-mode 'elixir-mode (kbd "f x") phoenix-server-start)
...
(custom-set-faces
 ...
 '(lsp-face-highlight-read ((t (:foreground "magenta"))))
 '(lsp-face-highlight-textual ((t (:foreground "magenta"))))
 '(lsp-face-highlight-write ((t (:foreground "magenta")))))
)
