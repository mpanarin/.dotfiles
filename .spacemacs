...
(custom-set-faces
 ...
 '(lsp-face-highlight-read ((t (:box (:line-width 1 :color "grey75" :style released-button)))))
 '(lsp-face-highlight-textual ((t (:box (:line-width 1 :color "grey75" :style released-button)))))
